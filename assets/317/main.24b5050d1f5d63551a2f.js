!(function (e) {
      ...
      return {
        "./sandtable_bg.js": {
          __wbg_random_ca8b31dc0375c2d4: function () {
            return t[37].exports.c();
          },
          __wbindgen_throw: function (e, n) {
            return t[37].exports.d(e, n);
          },
        },
      };
    },
  ...
  ((a.e = function (e) {
        ...
        ((s.charset = "utf-8"),
          ...
          (s.src = (function (e) {
            return (
              ...
              ({}[e] || e) +
              "." +
              { 1: "179d268cea0ecd97cd8f", 2: "a41e16ebde3958526303" }[e] +
              ".js"
            );
          })(e)));
        var f = new Error();
    ...
    return (
      ({ 2: [22] }[e] || []).forEach(function (e) {
        var t = o[e];
        if (t) n.push(t);
        else {
          var r,
            u = i[e](),
            c = fetch( "" + { 22: "d6bb8247b8782b05a4b7" }[e] + ".module.wasm",
            );
          if (
            u instanceof Promise &&
            "function" == typeof WebAssembly.compileStreaming
          )
            r = Promise.all([WebAssembly.compileStreaming(c), u]).then(
              function (e) {
...
//# sourceMappingURL=main.24b5050d1f5d63551a2f.js.map
